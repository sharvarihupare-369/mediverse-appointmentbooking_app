  ...
  return (
    <Flex mt="100px" justifyContent={{base:"center" , sm :"center" , md:"space-around" , lg:"space-around" ,xl:"space-around" , "2xl":"space-around"}} direction={{base:"column", sm:"column" , md:"row" , lg:"row" , xl : "row" , "2xl" : "row"}}>
      <Box w="50%">
        ...
        <Image src="https://img.freepik.com/free-vector/medical-booking-app_23-2148571935.jpg?w=740&t=st=1683523729~exp=1683524329~hmac=b3b8fb2f39e84c0dbaf1ccd49873632453a58e00f85196f0aed753efea29db47" />
      </Box>
